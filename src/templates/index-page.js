        ...
        <div className="row py-2">
            <div className="col-md-6 col-lg-6 col-xl-6 col-12 d-flex align-items-center justify-content-center justify-content-md-start">
               <div className="d-flex align-items-center ">
                   <h5 className="text-white font-weight-bold mt-1">LUEZOID TECHNOLOGY</h5>
               </div>
            </div>
            ...
            <div className="row">
                <div className="col-12 col-md-8 col-lg-8 col-xl-8">
                    <div className="banner-image-section">
                        <img src="assets/images/banner1.jpg" alt="" className="banner-image"/>
                    </div>
                </div>
            ...
            <div className="row pt-5 pb-5 px-3">
                <div className="col-12">
                    <div className="welcome-title">
                        <h5 className="text-center text-white">WELCOME TO <span className="theme-text-color">LUEZOID TECHNOLOGY</span>, TEST PRACTICE CENTRE</h5>
                    </div>
                </div>
                <div className="col-12 bg-white my-3"></div>
                <div className="text-white welcome-text">
                    <p>
                        This Mock Test is to familiarize the students about processes of Computer Based Test (CBT),
                        candidate can understand various processes of Computer Based Test (CBT) with the available mock
                        test.
                    </p>
                </div>
            </div>
